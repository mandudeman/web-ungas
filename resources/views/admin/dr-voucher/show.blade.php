                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                <thead>
                                <tr>
                                    <td> Branch Name: &nbsp; <span class="text-bold">{{ App\Transaction::find($items[0]->id)->Branch->name }}</span>
                                    </td>
                                    <td> Made Of Payment: &nbsp; <span class="text-bold">{{ App\Transaction::find($items[0]->id)->BankCash->name }}</span>
                                    </td>
                        ...
                        <div class="body">
                            <table class="table  table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>Created at: &nbsp; <span class="text-bold">{{ date(config('settings.date_format')." h:i:s", strtotime($items[0]->created_at)) }}</span>  </td>
