                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <table class="table  table-bordered table-hover">
                                                ...
                                                @if ($item->content)
                                                    <?php $sl=1; ?>
                                                    @foreach($item->content as $key=>$contents)
                                                        <tr>
                                                            <th class="text-center">
                                                                <input type="checkbox" id="md_checkbox_{{ $sl }}"
                                                                       class="chk-col-cyan selects "/>
                                                                <label for="md_checkbox_{{ $sl }}"></label>
                                                            </th>
                                                            <th scope="row" class="text-center">{{ $sl }}</th>
                                                            @foreach($contents as $key_content=>$content)
                                                                <td class="text-center">
                                                                    @if ($key_content==0)
                                                                        <input value="{{ $content }}" type="hidden"
                                                                               name="details[{{$key}}][{{$key_content}}]">
                                                                        {{ $content }}
                                                                    @elseif ($content==1)
                                                                        <div class="switch">
                                                                            <label>
