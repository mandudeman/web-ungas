...
$ModelName = \App\IncomeExpenseHead::class;
                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                                    ...
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        ...
                                                        @if (App\IncomeExpenseType::all()->count() >0 )
                                                            ...
                                                            $income_expense_type_id )
                                                                <option @if ( $income_expense_type_id->id == $item->income_expense_type_id)
                                                                        selected
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control  show-tick"
                                                        ...
                                                        @foreach( App\IncomeExpenseGroup::all() as $IncomeExpenseGroups )
                                                            <option @if ( $IncomeExpenseGroups->id == $item->income_expense_group_id )
                                                                    selected
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->unit }}" name="unit" type="text"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group form-float">
                                                ...
                                                <input value="1" name="type" type="radio" id="radio_1"
                                                       class="with-gap radio-col-cyan" @if ($item->type=='1')
                                                       checked
                                                       @endif />
                                                <label for="radio_1">Dr</label>
                                                <input value="0" name="type" type="radio" id="radio_2"
                                                       class="with-gap radio-col-cyan" @if ($item->type=='0')
                                                       checked
                                                       @endif />
