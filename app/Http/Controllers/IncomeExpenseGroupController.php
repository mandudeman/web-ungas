...
//    Important properties
    ...
    {
        $items = $this->parentModel::orderBy('code', 'desc')->paginate(60);
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'code' => 'required|string|unique:income_expense_groups',
        ]);
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'code' => 'sometimes|string|unique:income_expense_groups,code,'.$id,
        ]);
